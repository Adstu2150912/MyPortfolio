/**
 * Guest country selection functionality for booking form
...
document.addEventListener('DOMContentLoaded', function() {
    // Get the guest form element
    const guestForm = document.getElementById('guest-info-form');
    
    // Add form submission handler
    if (guestForm) {
        guestForm.addEventListener('submit', function(e) {
            const countryCodeSelect = document.getElementById('guest-country-code');
            const customCountryCodeInput = document.getElementById('guest_custom_country_code');
            const hiddenCountryCodeInput = document.getElementById('guest_country_code');
    ...
    function toggleCustomCountry() {
        const selectElement = document.getElementById('guest-country-select');
        const customCountryDiv = document.getElementById('guest_custom_country_div');
        const customCountryInput = document.getElementById('guest_custom_country');
        const hiddenCountryInput = document.getElementById('guest_country');
    ...
    function toggleCustomCountryCode() {
        const selectElement = document.getElementById('guest-country-code');
        const customCountryCodeDiv = document.getElementById('guest_custom_country_code_div');
        const customCountryCodeInput = document.getElementById('guest_custom_country_code');
        const hiddenCountryCodeInput = document.getElementById('guest_country_code');
    ...
    const payHotelRadio = document.getElementById('pay-hotel');
    const paymentOptionHidden = document.getElementById('payment-option-form');
    
    if (payNowRadio && payHotelRadio && paymentOptionHidden) {
        // Set initial value
        paymentOptionHidden.value = payNowRadio.checked ? 'now' : 'hotel';
        
        // Add event listeners for radio buttons
        payNowRadio.addEventListener('change', function() {
            if (this.checked) {
                paymentOptionHidden.value = 'now';
            }
        });
        
        payHotelRadio.addEventListener('change', function() {
            if (this.checked) {
                paymentOptionHidden.value = 'hotel';
            }
        });
    }
