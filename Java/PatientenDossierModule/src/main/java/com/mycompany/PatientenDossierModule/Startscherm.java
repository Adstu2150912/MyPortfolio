...
public class Startscherm
{
	...
	public FlowPane hoofdMenu, subMenu, hoofdVenster;
	...
	public Startscherm()
	{
		...
		Image logo = new Image("file:src/main/java/com/mycompany/PatiëntenDossierModule/IMG/DeGraafschapLogo.png");
		...
		//VBox.setVgrow(hoofdMenu, Priority.ALWAYS);
		VBox.setVgrow(hoofdVenster, Priority.ALWAYS);		
		
		
//		StackPane.setMargin(iView, new Insets(10, 10, 10, 10));
//		StackPane.setAlignment(iView, Pos.BOTTOM_CENTER);
