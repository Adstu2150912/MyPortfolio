...
import com.AAAD.Beroepsproduct3.SmartBrabant.TableView.holder.MoodCellViewHolder;
...
public abstract class TableViewAdapter extends AbstractTableAdapter<ColumnHeader, RowHeader, Cell> {
...
//        }
     ...
     */
    public void setActiviteitenLijst(List<Activiteit> list) {
        // Generate the lists that are used to TableViewAdapter
//        myTableViewModel.generateListForTableView(userList);
        TableViewModel.generateListForTvActiviteit(list);
        // Now we got what we need to show on TableView.
        setAllItems(TableViewModel.getColumHeaderModelActiviteitenList(), TableViewModel
                .getRowHeaderModelActiviteitenList(), TableViewModel.getCellModelActiviteitenList());
    }

    public void setIoTLijst(List<IoTApparaat> list)
    {
        // Generate the lists that are used to TableViewAdapter
        TableViewModel.generateListForTvIoTApparaat(list);
        // Now we got what we need to show on TableView.
        setAllItems(TableViewModel.getColumHeaderModelIoTList(), TableViewModel
                .getRowHeaderModelIoTList(), TableViewModel.getCellModelIoTList());
    }
}
