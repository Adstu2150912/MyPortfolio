...
import BP4_Model.Table.Parkeren;
...
public class DBParkeren extends DatabaseTable{
    ...
    public void insertDataIntoTable(Object instance)
    {
        ...
        DatabaseHandlers.parkeren.select("Email='" + ((Parkeren) instance).getsEML() + "'");
...
//        System.out.println(query);
    ...
    public void UpdateDataIntoTable(Object fromInstance, Object toInstance)
    {
        ...
        DatabaseHandlers.parkeren.select("Email='" + ((Parkeren) toInstance).getsEML() + "'");
        if(DatabaseHandlers.parkeren.getResults().length <= 0)
        {
