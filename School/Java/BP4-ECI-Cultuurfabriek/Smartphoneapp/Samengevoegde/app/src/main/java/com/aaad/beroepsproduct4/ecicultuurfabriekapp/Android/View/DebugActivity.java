...
//        DatabaseHandlers.emails.DeleteAll();
        DatabaseHandlers.dbEmail.insertDataIntoTable(TestEmails);
        DatabaseHandlers.dbEmail.selectAll();

        for(Object instance : DatabaseHandlers.dbEmail.getResults())
        {
            System.out.println(instance);
        }

        DatabaseHandlers.dbEmail.deleteSpecificData(TestEmails[0]);
        DatabaseHandlers.dbEmail.selectAll();
    ...
    public static void testGebruikers()
    {
        ...
        testgebruikers[0] = new Gebruiker("test1", "Test", "test", " ", "MAN", new Date(0), "Tiel", "Test", "1", "12345421123", "987987987");
        testgebruikers[1] = new Gebruiker("test2", "Test", "test", " ", "MAN", new Date(0), "Tiel", "Test", "1", "12345421123", "987987987");
        testgebruikers[2] = new Gebruiker("test3", "Test", "test", " ", "MAN", new Date(0), "Tiel", "Test", "1", "12345421123", "987987987");
        testgebruikers[3] = new Gebruiker("test4", "Test", "test", " ", "MAN", new Date(0), "Tiel", "Test", "1", "12345421123", "987987987");
        testgebruikers[4] = new Gebruiker("test5", "Test", "test", " ", "MAN", new Date(0), "Tiel", "Test", "1", "12345421123", "987987987");

        DatabaseHandlers.dbGebruiker.DeleteAll();

        DatabaseHandlers.dbGebruiker.insertDataIntoTable(testgebruikers);
        DatabaseHandlers.dbGebruiker.selectAll();


        for(Object instance : DatabaseHandlers.dbGebruiker.getResults())
        {
        ...
        DatabaseHandlers.dbGebruiker.UpdateDataIntoTable(testgebruikers[0], testgebruikers[1]);
        DatabaseHandlers.dbGebruiker.selectAll();
        ...
        DatabaseHandlers.dbGebruiker.deleteSpecificData(testgebruikers[0]);
        DatabaseHandlers.dbGebruiker.selectAll();
    ...
    public static void testReserveringen()
    {
        ...
        DatabaseHandlers.dbReservering.DeleteAll();

        DatabaseHandlers.dbReservering.insertDataIntoTable(testReserveringen);
        DatabaseHandlers.dbReservering.selectAll();


        for(Object instance : DatabaseHandlers.dbReservering.getResults())
        {
        ...
        DatabaseHandlers.dbReservering.insertDataIntoTable(testReserveringen[0]);
        DatabaseHandlers.dbReservering.UpdateDataIntoTable(testReserveringen[0], testReserveringen[1]);
        DatabaseHandlers.dbReservering.selectAll();
        ...
        DatabaseHandlers.dbReservering.deleteSpecificData(testReserveringen[1]);
        DatabaseHandlers.dbReservering.selectAll();
    ...
    public static void testDBCursus()
    {
        ...
        {
            Log.d("Testdata DB Cursus", "variable cursusID : " + ((Cursus)instance).getCursusID());
            Log.d("Testdata DB Cursus", "variable cursusNaam : " + ((Cursus)instance).getCursusNaam());
            Log.println(Log.DEBUG, "Testdata DB Cursus", "variable lesPrijs : " + ((Cursus)instance).getLesPrijs());
        }
    ...
    public static void testDBDocent()
    {
        ...
        {
            Log.d("Testdata DB Docent",   "variable docentID : " + ((Docent)instance).getDocentID());
            Log.d("Testdata DB Docent",    "      variable docentNaam : " + ((Docent)instance).getDocentNaam());
            Log.println(Log.DEBUG,"Testdata DB Docent",  "      variable discipline : " + ((Docent)instance).getDiscipline());
        }
    ...
    public static void testDBCursusCategorie()
    {
        ...
        {
            Log.d( "Testdata DB Cursuscategorie",   "variable categorieID : " + ((Cursuscategorie)instance).getCategorieID());
            Log.d( "Testdata DB Cursuscategorie",   "      variable catergorieNaam : " + ((Cursuscategorie)instance).getCategorieNaam());
            Log.println(Log.DEBUG, "Testdata DB Cursuscategorie",   "      variable subCategorieNaam : " + ((Cursuscategorie)instance).getSubCategorie());
        }
