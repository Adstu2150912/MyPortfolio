...
public class HttpConnectionService {
    ...
    public String sendRequest(String path, HashMap<String, String> params, AbstractMap.SimpleEntry<String, String> contentType) {
        try {
            response = "";
            ...
            conn.setRequestProperty(contentType.getKey(), contentType.getValue());
