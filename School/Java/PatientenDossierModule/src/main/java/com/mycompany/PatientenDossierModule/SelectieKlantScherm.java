 ...
 * Aanmaakdatum: 15-10-2019
 * Project: Elektronisch Patiëntendossier - De Graafschap
 * Bestandsnaam: SelectieKlantScherm.java
 */

public class SelectieKlantScherm 
{	
	...
	public SelectieKlantScherm() 
	{
		...
		lblKlant = new Label("Selecteer klant:");
