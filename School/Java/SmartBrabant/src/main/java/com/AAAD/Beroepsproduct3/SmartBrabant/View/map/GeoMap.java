package com.AAAD.Beroepsproduct3.SmartBrabant.View.map;
 ...
 */
public class GeoMap extends Parent {
    ...
    private static final Logger log
            = Logger.getLogger(GeoMap.class.getName());
...
//    private static String WPSG_WGS84 = "EPSG:28992"; //Code naam (EPSG) projectienaam 'Rijksdriehoekscooördinaten' met betrekking tot cartografie van Nederland 
//    private static String WGS84 = "28992";
     ...
     * @throws Exception 
     */
    public GeoMap(WebMapServer wms, Layer layer, int dimensionX, int dimensionY, org.opengis.geometry.Envelope bounds) throws IOException, FactoryException {
