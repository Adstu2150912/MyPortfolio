...
//include LEVEL."includes/js/jquery-3.1.1.min.js";
?>
...
<head>
    ...
    <script src="trekKaart.js"></script>
    <meta charset="utf-8" />
...
<body>
    ...
    <div id="wrapper">
        ...
        elseif (isset($_GET['inzet'])){
            echo "<hr>";
            echo "<script language='JavaScript'>$(document).ready(function() {doeIets(); }); </script>\n";
            printGetrokkenKaarten();
...
<script language="JavaScript">
    ...
    var totaalspeler = <?php echo $_SESSION['totaalspeler'] ?>;
