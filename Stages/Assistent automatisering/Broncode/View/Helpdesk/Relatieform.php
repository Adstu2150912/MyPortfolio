        ...
        if($_POST["btnSubmit"] == "VASTLEGGEN" && $_POST["typeForm"] == "new")
        {
            ...
            if($isFormValid)
            {
                ...
                if($nieuwRegistratieID != false)
                {
                    ...
                    $aValues[] = $_POST["txtVestigingsadres"]; $aValues[] = $_POST["txtVestigingsPostcode"]; $aValues[] = $_POST["txtVestigingsWoonplaats"]; $aValues[] = ""; $aValues[] = ""; $aValues[] = "";
        ...
        {              
            ...
            if($result != false)
            {
                if($result->num_rows > 0)
                {
                    ...
                    if($row["ipBan"] == "1")
                    {
                        $jQueryVerversForm .= " $('#tdBlokkade').append('<input type=\"checkbox\" name=\"chkBlokkade\" checked><font color=red style=\"background: white;\">!!!!!!!!!!!!!!!!!!!!!!!</font>');";
                    }
                    else
                        $jQueryVerversForm .= " $('#tdBlokkade').append('<input type=\"checkbox\" name=\"chkBlokkade\">');";
                    ...
                    {
                        if($row["bewaking"] == "1")
                            $jQueryVerversForm .= "$('#tdBewaking').append('<b>Bewaking?</b>&nbsp;&nbsp;<input type=\"checkbox\" name=\"bewaking\" checked><font color=red style=\"background: white;\">!!!!!!!!!!!!!!!!!!!!!!!</font>');";
                        else
                  ...
                  <table class="u-table-entity">
                    ...
                    <tbody class="u-table-body">
                      <tr style="height: 30px;">
                        <td class="u-table-cell u-table-cell-1">KvK-nummer:</td>
                        <td class="u-table-cell "><input type="text" id="txtKvKNr" name="txtKvKNr" value=""></td>
                        <td class="u-table-cell u-table-cell-3">Kantoornaam*:</td>
                        ...
                        <td class="u-table-cell u-table-cell-5" colspan="2"><font color=red style="background: white;">Let op: hier mogen geen spaties aan het einde voorkomen​*</font></td>                        
                      ...
                      <tr style="height: 30px;">
                        ...
                        <td class="u-border-1 u-border-grey-40 u-border-no-left u-border-no-right u-table-cell u-table-cell-15" colspan="4"><font color="red" style="background: white;">Noteren als "t.a.v. de heer J. Jansen" of "t.a.v. mevrouw W. de Wit</font></td>
                        <td class="u-border-1 u-border-grey-40 u-border-no-left u-border-no-right u-table-cell"></td>
              ...
              <div class="u-table u-table-responsive u-table-1">
                <table class="u-table-entity">
                  ...
                  <tbody class="u-table-body">
                    ...
                    <tr style="height: 30px;">
                      <td class="u-border-1 u-border-grey-40 u-border-no-left u-border-no-right u-table-cell u-table-cell-17">LinkedIn:</td>
                      ...
                      <td class="u-border-1 u-border-grey-40 u-border-no-left u-border-no-right u-table-cell u-table-cell-19"></td>
                      <td class="u-border-1 u-border-grey-40 u-border-no-left u-border-no-right u-table-cell"></td>
                    </tr>
                    <tr style="height: 30px;">
                ...
                <table class="u-table-entity">
                  ...
                  <tbody class="u-table-body">
                    ...
                    <tr style="height: 30px;">
                      ...
                      <td class="u-border-1 u-border-grey-40 u-border-no-left u-border-no-right u-grey-25 u-table-cell u-table-cell-10" colspan="3">
                    ...
                    <tr style="height: 30px;" class="assistentCRM">
                      ...
                      <td class="u-border-1 u-border-grey-40 u-border-no-left u-border-no-right u-table-cell" id="tdChkModules1" colspan="3">
                    ...
                    <tr style="height: 30px;" class="assistentCRM">
                        <td class="u-border-1 u-border-grey-40 u-border-no-left u-border-no-right u-table-cell" colspan="4">
                ...
                <table class="u-table-entity">
                  ...
                  <tbody class="u-table-body">
                    ...
                    <tr style="height: 30px;">
                      ...
                      <td class="u-border-1 u-border-grey-40 u-border-no-left u-border-no-right u-table-cell"><font color="red" style="background: white;">Let op!! Per datum alleen CFD óf commerciele korting! Niet beide!</font></td>
                    </tr>
                    <tr style="height: 30px;">
